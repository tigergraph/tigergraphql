...
Besides GSQL username and passwords, you can also use the `-gsqlsecret` flag and use a xref:tigergraph-server:user-access:managing-credentials.adoc#_secrets[secret] as your credential.
--
Windows::
+
--
